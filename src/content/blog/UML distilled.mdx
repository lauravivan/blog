...
import ClassDiagramOrderClient from "../../assets/class-diagram-order-vs-client.png"
import ClassDiagramGeneralization from "../../assets/class-diagram-generalization.png" 
import ClassDiagramAggComp from "../../assets/class-diagram-aggregation-vs-composition.png"
...
<figure>
  ...
  <Image src={ClassDiagramOrderClient} alt="Diagrama de Classes: exemplo pedido x cliente" />
...
<figure>
  ...
  <Image src={ClassDiagramGeneralization} alt="Diagrama de Classes: exemplo generalização"/>
  <figcaption>Fonte: elaborado pela autora (2025)</figcaption>
</figure>
...
<figure>
  ...
  <Image src={ClassDiagramAggComp} alt="Diagrama de Classes: exemplo agregação e composição"/>
  <figcaption>Fonte: elaborado pela autora (2025)</figcaption>
</figure>
